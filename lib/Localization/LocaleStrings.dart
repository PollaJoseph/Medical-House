...
class LocaleStrings extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en_US': {
      ...
      "Could not find a valid Patient ID.":
          "Could not find a valid Patient ID.",
      "Scan Required": "Scan Required",
      "Please scan a valid patient QR code first.":
          "Please scan a valid patient QR code first.",
      "Input Empty": "Input Empty",
      "Please specify the number of points to reward.":
          "Please specify the number of points to reward.",
      "Invalid Points": "Invalid Points",
      "Please enter a valid number for points.":
          "Please enter a valid number for points.",
      "Points Awarded": "Points Awarded",
      "Successfully added points!": "Successfully added points!",
      "Reward Workspace": "Reward Workspace",
      "TARGET PATIENT IDENTIFIER": "TARGET PATIENT IDENTIFIER",
      "Verified": "Verified",
      "Awaiting QR Scan...": "Awaiting QR Scan...",
      "Reset": "Reset",
      "Enter points to credit (e.g. 200)": "Enter points to credit (e.g. 200)",
      "Credit Loyalty Points": "Credit Loyalty Points",
      "Camera Feed Required": "Camera Feed Required",
      "Grant Camera Permission": "Grant Camera Permission",
    },
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    'ar_EG': {
      "Invalid QR Code": "رمز QR غير صحيح",
      "Could not find a valid Patient ID.": "لم يتم العثور على معرف مريض صحيح.",
      "Scan Required": "مطلوب مسح الرمز",
      "Please scan a valid patient QR code first.":
          "يرجى مسح رمز QR صحيح للمريض أولاً.",
      "Input Empty": "الحقل فارغ",
      "Please specify the number of points to reward.":
          "يرجى تحديد عدد النقاط للمكافأة.",
      "Invalid Points": "نقاط غير صحيحة",
      "Please enter a valid number for points.": "يرجى إدخال رقم صحيح للنقاط.",
      "Points Awarded": "تم منح النقاط",
      "Successfully added points!": "تم إضافة نقاط بنجاح!",
      "Reward Workspace": "مساحة عمل المكافآت",
      "TARGET PATIENT IDENTIFIER": "معرّف المريض المستهدف",
      "Verified": "تم التحقق",
      "Awaiting QR Scan...": "في انتظار مسح رمز QR...",
      "Reset": "إعادة تعيين",
      "Enter points to credit (e.g. 200)":
          "أدخل النقاط المراد إضافتها (مثال: 200)",
      "Credit Loyalty Points": "إضافة نقاط الولاء",
      "Camera Feed Required": "مطلوب تشغيل الكاميرا",
      "Grant Camera Permission": "منح إذن الكاميرا",
      "All": "الكل",
      "Dental": "الأسنان",
